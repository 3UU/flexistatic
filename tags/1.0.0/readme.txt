...
deliver a website is static html content. But is not the best way for all
single posts of your blog because you are loseing the benefit of dynamic
elementslike captcha checks. So the optimal solution would be only make the
...
= Q: Why should I delete all static posts/pages before changing permalinks?
...
for all static URIs. But this will need additional storage in the database 
